...
if net_type == 'vgg16-ssd':
    ...
    print("The net type is wrong. It should be one of vgg16-ssd, mb1-ssd and mb1-ssd-lite.")
    sys.exit(1)
#image_path = r'/home/liuqw/mobilenetSSDptorch/data/VOC2007/JPEGImages/train_45.jpg'
image_path = r'/home/liuqw/mobilenetSSDptorch/pytorch-ssd-master/readme_ssd_example.jpg'
