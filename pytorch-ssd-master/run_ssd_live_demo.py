...
timer = Timer()
imgsPath = "/home/liuqw/mobilenetSSDptorch/data/VOC20071/JPEGImages"
savePath = "/home/liuqw/mobilenetSSDptorch/data/result"
# while True:
for picName in os.listdir(imgsPath):
    picPath = os.path.join(imgsPath, picName)
    orig_image = cv2.imread(str(picPath))
    ...
    for i in range(boxes.size(0)):
        ...
        cv2.putText(orig_image, label,
                    ...
                    (255, 0, 255),
                    2)  # line type
    img_path = os.path.join(savePath, picName)
    cv2.imwrite(img_path, orig_image)
    # orig_image.save(img_path)
